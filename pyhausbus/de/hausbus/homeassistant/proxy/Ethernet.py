...
class Ethernet(ABusFeature):
  ...
  def wakeUpDevice(self, mac5:int, mac4:int, mac3:int, mac2:int, mac1:int, mac0:int):
    logging.info("wakeUpDevice"+" mac5 = "+str(mac5)+" mac4 = "+str(mac4)+" mac3 = "+str(mac3)+" mac2 = "+str(mac2)+" mac1 = "+str(mac1)+" mac0 = "+str(mac0))
  ...
  def Configuration(self, IP0:int, IP1:int, IP2:int, IP3:int, options:MOptions, Server_Port:int, Server_IP0:int, Server_IP1:int, Server_IP2:int, Server_IP3:int):
    logging.info("Configuration"+" IP0 = "+str(IP0)+" IP1 = "+str(IP1)+" IP2 = "+str(IP2)+" IP3 = "+str(IP3)+" options = "+str(options)+" Server_Port = "+str(Server_Port)+" Server_IP0 = "+str(Server_IP0)+" Server_IP1 = "+str(Server_IP1)+" Server_IP2 = "+str(Server_IP2)+" Server_IP3 = "+str(Server_IP3))
  ...
  def setConfiguration(self, IP0:int, IP1:int, IP2:int, IP3:int, options:MOptions, Server_Port:int, Server_IP0:int, Server_IP1:int, Server_IP2:int, Server_IP3:int):
    logging.info("setConfiguration"+" IP0 = "+str(IP0)+" IP1 = "+str(IP1)+" IP2 = "+str(IP2)+" IP3 = "+str(IP3)+" options = "+str(options)+" Server_Port = "+str(Server_Port)+" Server_IP0 = "+str(Server_IP0)+" Server_IP1 = "+str(Server_IP1)+" Server_IP2 = "+str(Server_IP2)+" Server_IP3 = "+str(Server_IP3))
